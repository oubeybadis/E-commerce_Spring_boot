        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/", "/css/**", "/js/**", "/imgs/**", "/storage/**")
                                                .permitAll()
                                                .requestMatchers("/login", "/register", "/password/**").permitAll()
                                                .requestMatchers("/products/**", "/client/**").permitAll()
                                                .requestMatchers("/api/**").permitAll()
                                                .requestMatchers("/admin/**")
                                                .hasAnyRole("ADMIN", "EMP_CREDITS", "EMP_CONFERMATION")
                                                .requestMatchers("/admin/dashboard", "/admin/products/**",
                                                                "/admin/categories/**",
                                                                "/admin/themes/**")
                                                .hasRole("ADMIN")
                                                .requestMatchers("/admin/orders/**", "/admin/customers/**",
                                                                "/admin/deleverys/**")
